...
//    	    	break;
	...
	ClientImpl.prototype._doConnect = function (wsurl) {
		...
		// this failed on some server
		//this.socket = new WebSocket(wsurl, ["mqtt","mqttv3.1"]);
		// L. TRABATTONI
		//    Because Chrome and Internet Explorer failed to connect to mosquitto websocket server,
		//    if the Sec-WebSocket-Protocol header contains a comma separated list
		//    you must explicitly set mqttVersion of the connectionOptions to 3 or 4
		if (this.connectOptions.mqttVersionExplicit === true) {
	...
	ClientImpl.prototype._on_socket_open = function () {
		...
		try {
			...
			console.log("mqttws31.j: _on_socket_open() failed");
		}
	...
	ClientImpl.prototype._on_socket_message = function (event) {
		try {
			...
			console.log("mqttws31.j: _on_socket_message() failed");
		}
	...
	ClientImpl.prototype._on_socket_error = function (error) {
		try {
			...
			console.log("mqttws31.j: _on_socket_error() failed");
		}
	};
	...
	ClientImpl.prototype._on_socket_close = function () {
		try {
			...
			console.log("mqttws31.j: _on_socket_close() failed");
		}
	};
	...
	ClientImpl.prototype._socket_send = function (wireMessage) {
		try {
			...
			console.log("mqttws31.j: _on_socket_send() failed");
		}
	};
	...
	var Client = function (host, port, path, clientId) {
	    ...
	    if (arguments.length == 2) {
			...
			//console.log("mqttws31.js - websocket uri is: " + uri);
		}
